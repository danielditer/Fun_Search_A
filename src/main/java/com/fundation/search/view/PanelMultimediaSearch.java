...
public class PanelMultimediaSearch extends JPanel{
    ...
    private void initComponents() {
        ...
        //======== panelDuration ========
        {
            ...
            panelDuration.add(spinner1, new TableLayoutConstraints(1, 0, 1, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
            ...
            panelDuration.add(spinner2, new TableLayoutConstraints(3, 0, 3, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        }
        ...
        //======== panelFrameRate ========
        {
            ...
            //---- label5 ----
            label5.setText("More than");
            panelFrameRate.add(label5, new TableLayoutConstraints(0, 0, 0, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
            panelFrameRate.add(spinner3, new TableLayoutConstraints(1, 0, 1, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

            //---- label6 ----
            label6.setText("Less than");
            panelFrameRate.add(label6, new TableLayoutConstraints(2, 0, 2, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
            panelFrameRate.add(spinner4, new TableLayoutConstraints(3, 0, 3, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        }
        ...
        //======== panelCodec ========
        {
            ...
            panelCodec.add(label7, new TableLayoutConstraints(0, 0, 0, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
            panelCodec.add(textField3, new TableLayoutConstraints(1, 0, 3, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

            //---- label8 ----
            label8.setText("Audio codec");
            panelCodec.add(label8, new TableLayoutConstraints(4, 0, 4, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
            panelCodec.add(textField4, new TableLayoutConstraints(5, 0, 7, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        }
        ...
        //======== panel5 ========
        {
            ...
            panel5.add(comboBox1, new TableLayoutConstraints(0, 0, 0, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        }
        add(panel5, new TableLayoutConstraints(0, 4, 0, 4, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        ...
        //======== panel8 ========
        {
            ...
            panel8.add(checkBox5, new TableLayoutConstraints(0, 0, 0, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

            //---- checkBox6 ----
            checkBox6.setText("Hidden");
            panel8.add(checkBox6, new TableLayoutConstraints(2, 0, 2, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        }
        add(panel8, new TableLayoutConstraints(0, 6, 0, 6, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
